...
josh = Repo.insert!(%User{full_name: "Josh Pensky", email: "joshpensky@msgr.com", username: "josh_jpeg", bio: "I draw things", password_hash: Comeonin.Argon2.add_hash("notapassword").password_hash})
aoun = Repo.insert!(%User{full_name: "Joseph Aoun", email: "aounson@neu.edu", username: "ilovehuskies", bio: "I hate dining hall workers", password_hash: Comeonin.Argon2.add_hash("iloveneu").password_hash})
eric = Repo.insert!(%User{full_name: "Eric Harris", email: "ebharris@you.me", username: "yinyangbangarang", bio: "I love pandas", password_hash: Comeonin.Argon2.add_hash("sushifan98").password_hash})
nath = Repo.insert!(%User{full_name: "Nathan Fielder", email: "nathan4u@cc.com", username: "onyourside", bio: "So, you wanna, like, hang out sometime? It's cool if not...", password_hash: Comeonin.Argon2.add_hash("jimmykimmel").password_hash})
